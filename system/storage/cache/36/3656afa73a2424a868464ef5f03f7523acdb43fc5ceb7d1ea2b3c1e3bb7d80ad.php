...
class __TwigTemplate_5a99667b0a22176fcd39af66cf2fe4bf29cf58d3f005ed3463f883138841f528 extends Twig_Template
{
  ...
  <table style=\"border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            // line 81
            echo "    <tr>
      <td style=\"font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: center; padding: 7px;\"><a href=\"";
            // line 82
            ...
            echo "\" title=\"";
            echo $this->getAttribute($context["product"], "name", array());
            echo "\"  style=\"vertical-align:middle;\" /></a>
        ";
            // line 83
            $context['_parent'] = $context;
...
/*     <tr>*/
/*       <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: center; padding: 7px;"><a href="{{ product.href}}"><img src="{{ product.thumb}}" alt="{{ product.name }}" title="{{ product.name }}"  style="vertical-align:middle;" /></a>*/
